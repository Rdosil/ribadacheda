        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            ...
            <div className="animate-on-scroll">
              ...
              <h2 className="text-3xl font-bold mb-6 text-gray-900 font-serif">Ponte en contacto</h2>
              <p className="text-gray-600 mb-10">
                Estamos a tu disposición para resolver cualquier duda o consulta. Puedes contactarnos a través del formulario o directamente por teléfono o correo electrónico.
              </p>
              
              <div className="space-y-6">
                <div className="flex items-start">
                  <div className="flex-shrink-0 bg-wine-50 p-3 rounded-full">
                    <Phone className="h-6 w-6 text-wine-600" />
                  </div>
                  <div className="ml-4">
                    <h3 className="text-lg font-medium text-gray-900">Teléfono</h3>
                    <p className="mt-1 text-gray-600">636488337</p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div className="ml-4">
                    ...
                    <p className="mt-1 text-gray-600">ribadacheda@gmail.com</p>
                  </div>
                </div>
                
                <div className="flex items-start">
                  <div className="flex-shrink-0 bg-wine-50 p-3 rounded-full">
                    <MapPin className="h-6 w-6 text-wine-600" />
                  </div>
                  <div className="ml-4">
                    <h3 className="text-lg font-medium text-gray-900">Dirección</h3>
                    <p className="mt-1 text-gray-600">Lariño 362, Carnota, 15292, A Coruña, España</p>
                  </div>
                </div>
              </div>
              ...
              <div className="mt-10">
                ...
                <div className="flex space-x-4">
                  <a 
                    href="#" 
                    className="bg-wine-50 p-3 rounded-full text-wine-600 hover:bg-wine-100 transition-colors"
                    aria-label="Facebook"
                  >
            ...
            {/* Contact Form */}
            <div className="bg-white rounded-xl shadow-elegant p-8 animate-on-scroll" style={{ transitionDelay: '0.2s' }}>
              <h3 className="text-xl font-bold mb-6 text-gray-900 font-serif">Envíanos un mensaje</h3>
          ...
          {/* Map */}
          <div className="mt-16 rounded-xl overflow-hidden shadow-elegant h-96 animate-on-scroll">
            <iframe 
