        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
          <div>
            <div className="flex items-center space-x-2 mb-6">
              <Wine className="h-7 w-7 text-wine-300" />
              <span className="text-xl font-serif font-semibold text-white">
                Riba da Cheda
              </span>
            </div>
            <p className="text-gray-400 mb-6">
              Disfruta de una experiencia gastronómica única en un entorno incomparable en la Costa da Morte.
            </p>
          ...
          <div>
            <h3 className="text-lg font-medium text-white mb-6">Enlaces rápidos</h3>
          ...
          <div>
            <h3 className="text-lg font-medium text-white mb-6">Horario</h3>
            <ul className="space-y-4 text-gray-400">
              ...
              <li className="flex justify-between mt-4 pt-4 border-t border-gray-800">
                <span>Cerrado</span>
                <span>Domingo noche y lunes</span>
              </li>
            </ul>
          </div>
          
          <div>
            <h3 className="text-lg font-medium text-white mb-6">Contacto</h3>
            <ul className="space-y-4 text-gray-400">
              <li className="flex items-start">
                ...
                <span>Lariño 362, Carnota, 15292, A Coruña, España</span>
              </li>
              <li className="flex items-start">
                <svg className="h-5 w-5 mr-3 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
              ...
              <li className="flex items-start">
                ...
                <span>ribadacheda@gmail.com</span>
              </li>
            </ul>
          </div>
        </div>
